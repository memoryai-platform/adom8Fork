    ...
    <div>
      ...
      <div className="mt-3 rounded-xl border border-gray-200 bg-gray-50 p-4">
        ...
        <button
          ...
          className="mt-4 inline-flex w-full items-center justify-center rounded-xl bg-ado-500 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-ado-600 disabled:cursor-not-allowed disabled:bg-ado-300"
        >
      ...
      >
        <div className="mb-8 flex items-center justify-between pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="flex items-center gap-3">
            <img src="/brand/logo-option-chunky-infinity-box.svg" alt="ADOm8" className="h-10 w-10" onError={(e) => { e.target.style.display = 'none'; }} />
            <span>
