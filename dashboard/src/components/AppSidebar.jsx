    ...
    <li>
      <NavLink
        ...
        className={({ isActive }) => `flex items-center rounded-lg px-3 py-2 text-sm font-medium transition ${
          isActive ? 'bg-ado-600/[0.12] text-ado-600' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'
        }`}
      >
        {({ isActive }) => (
          <>
            <span className={`mr-3 transition ${isActive ? 'text-ado-600' : 'text-gray-400'}`}>{icon}</span>
            <span>{label}</span>
          </>
        )}
      </NavLink>
      ...
      >
        <div className="mb-8 flex items-center justify-between pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="flex items-center gap-3">
            <img src="/brand/logo-option-chunky-infinity-box.svg" alt="ADOm8 logo" className="h-10 w-10" />
            <span>
        ...
        <div className="mt-auto rounded-xl border border-gray-200 bg-gray-50 p-4">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-3 inline-flex text-sm font-medium text-ado-600 hover:text-ado-700"
          >
            adom8.dev
          </a>
        </div>
