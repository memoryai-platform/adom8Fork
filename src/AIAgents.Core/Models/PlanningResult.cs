...
public sealed record PlanningResult
{
    ...
    /// <summary>
    /// Feature-mode decomposition generated by the planning agent.
    /// </summary>
    public FeatureDecomposition? Decomposition { get; init; }
...
public sealed record FeatureDecomposition
{
    public IReadOnlyList<FeatureChildStoryPlan> ChildStories { get; init; } = [];
}

public sealed record FeatureChildStoryPlan
{
    public required string Title { get; init; }
    public required IReadOnlyList<string> AcceptanceCriteria { get; init; }
    public required int Complexity { get; init; }
    public IReadOnlyList<string> SiblingDependencies { get; init; } = [];
}
