...
public sealed class GitHubCodebaseOnboardingService : ICodebaseOnboardingService
{
    ...
    private static string BuildOrchestrationContractMarkdown()
    {
        ...
        sb.AppendLine("4. If score is below threshold, move story to Needs Revision with required clarifications.");
        sb.AppendLine("5. If score meets threshold, proceed and document assumptions/choices used to continue.");
        sb.AppendLine();
