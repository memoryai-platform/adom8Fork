...
Create one documentation file per feature.";
        ...
        string repoPath, CodebaseAnalysisMetadata metadata, CancellationToken ct)
    {
        ...
        sb.AppendLine("3. **AI-Assisted Tools** — Claude Code CLI, Cursor, and GitHub Copilot benefit from this context");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("**When using Claude Code / Cursor / Copilot:**");
        sb.AppendLine("- Include `.agent/` context in your prompts");
        sb.AppendLine("- Use `scripts/claude-with-context.sh` helper");
